...
export const tips = [
  {
    ...
    body: [
      ...
      { type: 'image', src: placeholderImage('시스템 정보 — 베이스보드 제품(메인보드 모델) 확인 위치'), caption: '시스템 정보 — 베이스보드 제품(메인보드 모델) 확인 위치' },
      { type: 'image', src: placeholderImage('시스템 정보 — BIOS 버전/날짜 확인 위치'), caption: '시스템 정보 — BIOS 버전/날짜 확인 위치' },
      ...
      { type: 'steps', items: [
        ...
        '같은 페이지에서 아래로 스크롤하거나 "고급 그래픽 설정"을 눌러 "하드웨어 가속 GPU 일정 예약(HAGS)"을 찾으세요 (윈도우 버전에 따라 위치가 조금 다를 수 있습니다)',
        '켜진 상태와 꺼진 상태 각각으로 평소 하는 게임을 몇 분씩 켜보고, 프레임이 더 안정적인 쪽으로 두세요 (설정을 바꾸면 재부팅을 요구할 수 있습니다)',
      ] },
      { type: 'image', src: placeholderImage('디스플레이 > 그래픽 — "창 게임에 대해 최적화" 스위치 위치'), caption: '디스플레이 > 그래픽 — "창 게임에 대해 최적화" 스위치 위치' },
      { type: 'paragraph', text: '④ 게임 모드를 켜두세요.' },
      { type: 'steps', items: [
        '설정 > 게임 > 게임 모드로 이동',
        '스위치를 켜짐으로 설정',
      ] },
      { type: 'image', src: placeholderImage('설정 > 게임 > 게임 모드 화면'), caption: '설정 > 게임 > 게임 모드 화면' },
      { type: 'paragraph', text: '⑤ 전원 관리 모드를 고성능 쪽으로 설정하세요.' },
      { type: 'steps', items: [
        '설정 > 시스템 > 전원으로 이동',
        '"전원 모드"를 "최고의 성능" 또는 "고성능"으로 변경 (노트북은 배터리가 빨리 닳을 수 있으니, 충전기를 연결한 상태에서 게임하는 걸 추천합니다)',
      ] },
      { type: 'image', src: placeholderImage('설정 > 시스템 > 전원 — 전원 모드 선택 화면'), caption: '설정 > 시스템 > 전원 — 전원 모드 선택 화면' },
      ...
      { type: 'image', src: placeholderImage('고급 디스플레이 — 해상도·새로고침 빈도 확인 화면'), caption: '고급 디스플레이 — 해상도·새로고침 빈도 확인 화면' },
    ],
    tags: ['게임설정', '드라이버', 'HAGS'],
    date: '2026-08-16',
  },
