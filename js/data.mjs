...
export const tips = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'image', src: placeholderImage('작업 관리자 > 성능 탭 화면'), caption: '작업 관리자 > 성능 탭 화면' },
      { type: 'image', src: placeholderImage('스팀 설정 > 게임 관련 > 오버레이 성능 모니터'), caption: '스팀 설정 > 게임 관련 > 오버레이 성능 모니터' },
      ...
      { type: 'image', src: placeholderImage('CPU 온도 모니터링 화면'), caption: 'CPU 온도 모니터링 화면' },
      ...
      { type: 'image', src: placeholderImage('GPU 온도 모니터링 화면'), caption: 'GPU 온도 모니터링 화면' },
      ...
      { type: 'image', src: placeholderImage('작업 관리자 > 메모리 — 슬롯/속도 확인 화면'), caption: '작업 관리자 > 메모리 — 슬롯/속도 확인 화면' },
