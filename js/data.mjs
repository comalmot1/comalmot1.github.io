...
export const tips = [
  ...
  },
  {
    ...
    body: [
      { type: 'paragraph', text: '혹시 게임할 때 프레임이 갑자기 뚝뚝 떨어지는데, PC에 문제가 있는 것 같긴 한데 정확히 뭐가 문제인지는 모르겠고, 별거 아닐 수도 있는데 대뜸 수리점부터 가기엔 부담스러우신가요? 그렇다면 이 자가진단법이 도움이 될 거예요.' },
      { type: 'paragraph', text: '특별한 지식 없이 간단한 무료 프로그램만 따라서 켜보면 됩니다. 다만 변수는 늘 존재하고, 특히 소프트웨어가 아니라 하드웨어 자체의 문제라면 결국 전문가에게 맡기는 게 나을 수 있다는 점은 미리 알아두세요.' },
      ...
      { type: 'paragraph', text: '혹시 그냥 램 용량 자체가 부족하신가요? 위 방법으로는 해결이 안 되고, 램 가격 때문에 당장 추가 구매도 부담스럽다면 아래 팁을 참고하세요.', linkTipId: 'gamer-tips-3', linkText: '램 용량 부족 응급처치 보기' },
  ...
  },
  {
    ...
    body: [
      { type: 'paragraph', text: '혹시 요즘 램 가격 보고 깜짝 놀라셨나요? 크롬 탭을 몇 개만 열어도 버벅이고 게임 중에 갑자기 끊기는데, 당장 램을 추가로 살 여유는 없으신가요? 그렇다면 소프트웨어적으로 짜낼 수 있는 만큼 짜내보는 아래 방법들이 도움이 될 거예요.' },
      ...
      { type: 'image', src: 'images/tips/gamer3-virtual-memory.png', caption: '가상 메모리(페이지 파일) 설정 창' },
  ...
  },
  {
    ...
    body: [
      { type: 'paragraph', text: '혹시 FPS류 게임을 좋아하거나 이어폰 소리가 너무 작다고 느껴져서, 혹은 오디오 기능으로 저음 보강·음향 강도 이퀄라이제이션 기능을 사용하고 싶은데 기능이 안 보이거나, 메인보드를 바꿨거나, 포맷을 했거나 드라이버 업데이트를 했는데 기능이 안 보이게 되셨나요? 그렇다면 이 방법을 써보시면 도움이 될 거예요.' },
      { type: 'paragraph', text: '일단, 사용 중이신 메인보드의 제조사 사이트에서 해당 보드에 맞는 오디오 드라이버를 찾아서 미리 다운로드 받아둬야 한다는 걸 염두에 두시고 진행해주세요.' },
  ...
  },
  {
    ...
    body: [
      { type: 'paragraph', text: '혹시 새 PC를 사셨거나, 인터넷에서 "필수 프로그램" 추천 글을 보다가 유료 백신까지 따로 깔아야 하나 고민되시나요? 그렇다면 이 글이 도움이 될 거예요.' },
      { type: 'paragraph', text: '결론부터 말하면 대부분의 경우 윈도우에 기본 내장된 "Microsoft Defender(윈도우 디펜더)"만으로 충분합니다.' },
  ...
  },
  {
    ...
    body: [
      { type: 'paragraph', text: '혹시 DNS도 바꿔봤는데 여전히 인터넷이 느리거나, 와이파이가 자꾸 끊기시나요? 그렇다면 공유기(라우터) 쪽 문제일 수 있어요.' },
      { type: 'paragraph', text: '아래 순서대로 하나씩 확인해보세요.' },
  ...
  },
  {
    id: 'gamer-tips-6',
    category: 'gamer-tips',
    title: '부품별 적정 온도 · 이상 온도 기준표',
    summary: 'CPU(인텔·라이젠 non-X3D·라이젠 X3D)·그래픽카드·RAM·SSD, 상태별로 몇 도까지가 정상인지 표로 정리했습니다.',
    thumbnail: placeholderThumb(7, '부품별 적정 온도 · 이상 온도 기준표'),
    body: [
      { type: 'paragraph', text: '혹시 컴퓨터가 너무 뜨거운 것 같아서 걱정되는데, 정작 "몇 도부터 위험한 건지" 기준을 몰라서 답답하셨나요? 그렇다면 이 표가 도움이 될 거예요.' },
      { type: 'paragraph', text: '"프레임드랍 원인 자가진단법"(팁 2번)에서 HWMonitor로 온도를 확인하는 법은 다뤘는데, 정작 기준이 없으면 판단하기 어렵죠. 부품별로 유휴(Idle)·게이밍·풀부하 상태에서의 일반적인 온도 범위와, 이상 신호로 볼 수 있는 기준을 표로 정리했습니다.' },
      { type: 'paragraph', text: '⚠ 참고용 일반 기준입니다. 공랭·수랭 등 쿨링 방식, 케이스 통풍, 실내 온도에 따라 실제 수치는 달라질 수 있고, 확실한 최대 허용 온도는 제조사 스펙(예: CPU-Z, HWiNFO에서 확인 가능한 Tjmax)이 우선입니다.' },
      { type: 'paragraph', text: '① CPU — 인텔 / 라이젠 (non-X3D) / 라이젠 X3D' },
      { type: 'table',
        headers: ['상태', '인텔', '라이젠 (non-X3D)', '라이젠 X3D'],
        rows: [
          ['유휴(Idle)', '30~45°C', '35~50°C', '35~50°C'],
          ['게이밍', '60~80°C', '65~85°C', '60~85°C'],
          ['풀부하(렌더링·스트레스테스트)', '75~90°C', '80~95°C', '70~89°C'],
          ['이상 신호 기준', '지속 95°C 이상', '지속 95°C 초과 + 체감 성능 저하', '지속 89~95°C 초과 + 체감 성능 저하'],
        ] },
      { type: 'paragraph', text: '라이젠은 특히 non-X3D 모델일수록 게임 중 풀부하 시 Tjmax(약 95°C) 근처까지 올라가는 게 오히려 정상입니다 — AMD의 부스트 알고리즘이 안전 한계까지 최대한 성능을 끌어쓰도록 설계되어 있어서, 90°C 초반대라고 무조건 고장은 아닙니다. 라이젠 X3D는 세대에 따라 Tjmax가 다른데, 7000번대 X3D(7800X3D 등)는 89°C, 9000번대 X3D(9800X3D 등)는 95°C로 조금 더 높습니다.' },
      { type: 'paragraph', text: '② 그래픽카드 — NVIDIA / AMD' },
      { type: 'table',
        headers: ['상태', 'NVIDIA', 'AMD'],
        rows: [
          ['유휴(Idle)', '30~45°C', '30~45°C'],
          ['게이밍', '65~80°C', '65~83°C'],
          ['풀부하(스트레스테스트)', '75~88°C', '80~90°C'],
          ['이상 신호 기준', '지속 88°C 이상 (핫스팟 100°C 이상)', '엣지 온도 지속 90°C 이상'],
        ] },
      { type: 'paragraph', text: 'AMD 그래픽카드는 "정션(Junction) 온도"가 설계상 110°C까지도 정상 범위라 엣지(Edge) 온도만 보고 판단하는 게 정확합니다. NVIDIA는 GPU 온도와 별개로 "핫스팟" 온도가 훨씬 높게 나올 수 있는데, 핫스팟이 GPU 온도보다 20°C 이상 차이 난다면 서멀 재도포를 고려해볼 만합니다.' },
      { type: 'paragraph', text: '③ RAM — 논오버(기본 속도) / 튜닝(XMP·EXPO)' },
      { type: 'table',
        headers: ['상태', '논오버(기본 속도)', '튜닝(XMP·EXPO)'],
        rows: [
          ['유휴(Idle)', '30~35°C', '40~45°C'],
          ['게이밍·부하 시', '35~45°C', '45~66°C'],
          ['이상 신호 기준', '지속 70°C 이상', '지속 70°C 이상 (제조사 최대 허용치는 85°C)'],
        ] },
      { type: 'paragraph', text: 'XMP·EXPO로 튜닝하면 전압이 올라가서 기본 속도보다 5~20°C 정도 더 뜨거워지는 게 일반적입니다. 대부분의 DDR5는 85°C까지는 제조사 스펙상 정상 범위지만, 안정성을 생각하면 70°C 이하로 유지하는 걸 추천합니다.' },
      { type: 'paragraph', text: '④ SSD (NVMe 기준)' },
      { type: 'table',
        headers: ['상태', '온도'],
        rows: [
          ['유휴(Idle)', '30~40°C'],
          ['일반 사용(로딩 등)', '40~50°C'],
          ['헤비 로드(대용량 파일 전송)', '50~65°C'],
          ['이상 신호 기준(스로틀링 시작)', '지속 70~80°C 이상'],
        ] },
      { type: 'paragraph', text: 'SATA SSD는 발열이 훨씬 적어서 위 기준보다 대체로 10~20°C 낮게 나옵니다. NVMe SSD는 대용량 파일을 옮기거나 게임 설치처럼 오래 쓰기가 이어질 때 특히 뜨거워지기 쉬운데, 온도가 자꾸 70°C를 넘는다면 방열판(히트싱크)이 없는 M.2 슬롯을 쓰고 있지는 않은지 확인해보세요.' },
    ],
    tags: ['온도기준', 'CPU온도', 'GPU온도', '적정온도'],
    date: '2026-08-16',
  },
  {
    id: 'gamer-tips-7',
    category: 'gamer-tips',
    title: '마우스 폴링레이트, 무조건 높은 게 좋을까?',
    summary: '폴링레이트가 높으면 반응성은 좋아지지만, CPU나 게임이 못 받쳐주면 오히려 손해일 수 있습니다. 주요 게임 18종 반응까지 정리했습니다.',
    thumbnail: placeholderThumb(8, '마우스 폴링레이트, 무조건 높은 게 좋을까?'),
    body: [
      { type: 'paragraph', text: '혹시 마우스를 새로 알아보다가 "8000Hz 폴링레이트"라는 단어를 보고 무조건 높을수록 좋은 건지 궁금해지셨나요? 아니면 이미 고폴링 마우스를 쓰고 계신데 게임할 때 가끔 버벅이는 느낌이 들어서 원인이 궁금하셨나요? 그렇다면 이 글이 도움이 될 거예요.' },
      { type: 'paragraph', text: '① 먼저 폴링레이트가 뭔지부터 짚고 가겠습니다. 폴링레이트란 마우스가 1초에 몇 번이나 "지금 위치가 여기예요"라고 PC에 보고하는지를 나타내는 수치입니다. 1000Hz면 1초에 1000번(약 1밀리초 간격), 8000Hz면 1초에 8000번(약 0.125밀리초 간격) 보고합니다.' },
      { type: 'paragraph', text: '자주 보고할수록 PC가 마우스 위치를 더 촘촘하게 알 수 있어서, 화면에서 커서나 조준점이 더 부드럽고 즉각적으로 움직이는 느낌을 줄 수 있습니다.' },
      { type: 'callout', text: '정확히는 폴링레이트가 센서의 감지 "정밀도"(DPI)가 아니라 "반응성·부드러움"에 더 가까운 개념이라는 점만 짚고 갈게요. 체감 조준감에 영향을 주는 건 맞아서, 편의상 "정밀도"라고 불러도 크게 틀리진 않습니다.' },
      { type: 'paragraph', text: '숫자로 보면 그 차이는 생각보다 크지 않습니다. 1000Hz와 8000Hz의 보고 간격 차이는 계산상 최대 0.875밀리초(1ms − 0.125ms)뿐입니다.' },
      { type: 'paragraph', text: '사람이 자극에 반응하는 데 보통 150~250밀리초가 걸리는 것과 비교하면, 1밀리초도 안 되는 차이는 실전에서 체감하기 쉽지 않습니다. 다만 360Hz 이상의 초고주사율 모니터로 빠른 에임을 요구하는 FPS 게임을 하신다면, 이 미세한 차이가 그나마 의미를 가지는 편입니다.' },
      { type: 'paragraph', text: '② 문제는 여기서부터입니다. 폴링레이트가 높아질수록 CPU는 마우스와 그만큼 더 자주 통신해야 하고, 그때마다 약간의 처리 부담(오버헤드)이 발생합니다. 평소 CPU 사용률이 여유로운 시스템에서는 거의 체감되지 않지만, 이미 CPU가 게임 프레임을 만드느라 바쁜(CPU 병목 상태인) 시스템에서는 이 오버헤드가 그대로 평균 프레임 하락이나 순간적인 끊김으로 이어질 수 있습니다.' },
      { type: 'steps', items: [
        'Ctrl+Shift+Esc로 작업 관리자를 열고 "성능" 탭에서 CPU 사용률 확인',
        '평소 하시는 게임을 켠 상태에서 CPU 사용률이 꾸준히 70~80%를 넘는다면, 폴링레이트를 올렸을 때 오버헤드를 더 크게 느낄 가능성이 높습니다',
      ] },
      { type: 'paragraph', text: 'CPU 사용률을 더 자세히 확인하는 방법이나 프레임드랍의 다른 원인이 궁금하시다면 아래 팁을 참고하세요.', linkTipId: 'gamer-tips-2', linkText: '프레임드랍 원인 자가진단법 보기' },
      { type: 'paragraph', text: '③ 두 번째 변수는 지금 플레이하는 게임이 높은 폴링레이트를 얼마나 잘 소화하느냐입니다. 여기서도 한 가지 바로잡을 부분이 있는데, 게임이 높은 폴링레이트를 못 받아준다고 해서 단순히 "효과가 없는 정도"로 끝나는 게 아닙니다. 오히려 마우스를 빠르게 움직일 때 순간적으로 프레임이 뚝 떨어지거나 화면이 끊기는 역효과로 나타나는 경우가 실제로 보고되고 있습니다.' },
      { type: 'paragraph', text: '특히 언리얼 엔진(Unreal Engine) 기반의 최신 게임들에서 이런 사례가 유독 자주 보고되는데, 이 엔진이 애초에 초당 수천 번씩 쏟아지는 마우스 입력을 처리하도록 설계되지 않았기 때문이라는 분석이 많습니다.' },
      { type: 'paragraph', text: '④ 그럼 폴링레이트는 어떻게 확인하고 바꿀 수 있을까요? 보통 마우스 제조사의 전용 소프트웨어에서 설정합니다.' },
      { type: 'steps', items: [
        '로지텍 마우스는 "Logi Options+", 레이저는 "레이저 시냅스(Synapse)", 글로리어스는 "Glorious Core"처럼 제조사별 전용 프로그램을 설치',
        '프로그램 실행 후 마우스 설정 메뉴에서 "폴링레이트" 또는 "리포트 레이트(Report Rate)" 항목을 찾아 원하는 수치(125/500/1000/2000/4000/8000Hz 등)로 변경',
      ] },
      { type: 'callout', text: '결론: 폴링레이트는 무조건 높다고 좋은 게 아닙니다. 1000Hz가 여전히 가장 안정적인 기본값이고, 4000~8000Hz는 CPU 여유와 게임 호환성이 확인됐을 때만 의미가 있어요.' },
      { type: 'paragraph', text: '1000Hz는 2016년부터 게이밍 마우스 업계의 표준으로 자리 잡아 온 검증된 값입니다. 무작정 최고 수치로 맞추기보다는, 즐기시는 게임에서 직접 낮춰가며 프레임이 더 안정적인 지점을 찾아보시는 걸 추천합니다.' },
      { type: 'paragraph', text: '⑤ 마지막으로 소소한 팁 하나 — 커뮤니티에 보고된 경험을 바탕으로, 국내에서 많이 즐기는 주요 게임들이 8000Hz 폴링레이트를 대체로 잘 받아주는 편인지 정리해봤습니다. 다만 이건 공식 벤치마크가 아니라 유저들의 경험담을 취합한 수준이라 내 PC에서는 다를 수 있다는 점은 감안해주세요 — 결국 가장 정확한 방법은 본인 시스템에서 직접 낮춰가며 비교해보는 것입니다.' },
      { type: 'paragraph', text: '정밀 조준이 중요하면서도, 커뮤니티 기준으로는 비교적 안정적이라는 평가가 많은 게임' },
      { type: 'table',
        headers: ['게임', '엔진 / 참고'],
        rows: [
          ['리그 오브 레전드', 'Riot 자체 엔진'],
          ['오버워치 2', '블리자드 자체 엔진'],
          ['도타 2', 'Source 2 엔진'],
          ['에이펙스 레전드', 'Source 엔진(개조)'],
          ['레인보우 식스 시즈', 'AnvilNext 2.0'],
          ['서든어택', '오래되고 가벼운 개조 엔진'],
        ] },
      { type: 'paragraph', text: '언리얼 엔진 기반 최신작 위주로, 8000Hz에서 스터터·프레임드랍 보고가 특히 많은 게임 — 이런 게임은 1000~4000Hz를 권장합니다.' },
      { type: 'table',
        headers: ['게임', '엔진 / 참고'],
        rows: [
          ['배틀그라운드(PUBG)', 'Unreal Engine 4'],
          ['포트나이트', 'Unreal Engine 5'],
          ['마블 라이벌스', 'Unreal Engine 5'],
          ['더 퍼스트 디센던트', 'Unreal Engine 5'],
          ['발로란트', '2025년 UE5로 전환'],
        ] },
      { type: 'paragraph', text: '이 중 배틀그라운드는 국내 커뮤니티(퀘이사존, 디시인사이드 등)에도 관련 보고가 많습니다. 발로란트는 2025년 UE5 전환 이후라 아직 폭넓은 이슈 보고는 적지만, 다른 UE5 게임 사례를 볼 때 주의가 필요합니다.' },
      { type: 'paragraph', text: '참고로 카운터 스트라이크 2(Source 2 엔진)는 대체로 안정적이라는 평가가 많지만, 일부 유저는 4000Hz 이상에서 간헐적인 프레임드랍을 보고하기도 합니다. 애매하다면 1000Hz로 낮춰서 비교해보세요.' },
      { type: 'paragraph', text: '애초에 정밀 조준의 비중이 낮아서, 폴링레이트를 크게 신경 쓰지 않아도 되는 게임' },
      { type: 'table',
        headers: ['게임', '장르 특징'],
        rows: [
          ['메이플스토리', '2D 사이드스크롤러'],
          ['로스트아크', '핵앤슬래시 ARPG — 클릭 기반'],
          ['FC 온라인', '스포츠 게임 — 커서 조작 위주'],
          ['리니지 클래식', '클릭 기반 MMORPG'],
          ['로블록스', '캐주얼/다양한 장르 혼재'],
          ['디아블로4', '핵앤슬래시 ARPG — 클릭 기반'],
          ['마인크래프트', '정밀 에임이 승패를 가르지 않음'],
        ] },
    ],
    tags: ['폴링레이트', '마우스', 'CPU오버헤드', '게임설정'],
    date: '2026-08-16',
  },
  {
    id: 'gamer-tips-8',
    category: 'gamer-tips',
    title: '게임용 모니터 선택 기준',
    summary: '장르별로 뭐가 더 중요한지부터, 갖고 싶은 모니터 조합에 맞는 PC 사양까지 거꾸로 정리했습니다.',
    thumbnail: placeholderThumb(9, '게임용 모니터 선택 기준'),
    body: [
      { type: 'paragraph', text: '혹시 모니터를 새로 사려고 알아보다가, 24인치·27인치·32인치에 FHD·QHD·4K, 144Hz·165Hz·240Hz까지 조합이 너무 많아서 뭘 사야 할지 감이 안 잡히시나요? 아니면 이미 좋은 모니터를 사놓고 지금 PC로 그 성능을 다 뽑고 있는 건지 궁금하셨나요? 그렇다면 이 글이 도움이 될 거예요.' },
      { type: 'callout', text: '보통은 "PC 사양에 맞는 모니터"를 고르지만, 이 글은 반대로 갑니다 — 갖고 싶은 모니터(크기·해상도·주사율) 조합을 먼저 정하고, 그 모니터를 제대로 활용하려면 어떤 PC 사양이 필요한지 거꾸로 정리했습니다.' },
      { type: 'paragraph', text: '① 게임 장르별로 뭐가 더 중요한지부터 다릅니다. 발로란트·오버워치2·CS2·서든어택 같은 FPS·경쟁 게임은 주사율(반응성)이 최우선이라, 오히려 그래픽 옵션을 낮춰서라도 프레임을 최대한 뽑는 게 국룰입니다.' },
      { type: 'paragraph', text: '그래서 이런 게임은 GPU보다 CPU, 특히 캐시가 큰 X3D 계열 CPU가 병목이 되는 경우가 많습니다.' },
      { type: 'paragraph', text: '반대로 엘든링·사이버펑크·발더스 게이트 3 같은 오픈월드·싱글 RPG는 해상도와 그래픽 디테일이 체감에 더 크게 작용합니다. 주사율은 60~144Hz면 충분한 경우가 대부분이고, 여기서는 GPU가 절대적인 병목입니다.' },
      { type: 'paragraph', text: '리그 오브 레전드·스타크래프트 같은 MOBA·전략 게임은 요구 사양이 가장 낮은 편이라 위 두 기준 자체가 크게 의미 없습니다. 웬만한 사양이면 다 무난하게 돌아갑니다.' },
      { type: 'paragraph', text: '② 모니터 크기와 해상도도 어울리는 조합이 있습니다. 화면 선명도(픽셀 밀도) 기준으로 24인치엔 FHD, 27인치엔 QHD, 32인치 이상엔 4K가 잘 맞습니다.' },
      { type: 'paragraph', text: '③ 이 기준으로 실제 많이 쓰이는 모니터 조합 4가지를 골라서, 조합별로 필요한 PC 사양을 정리했습니다.' },
      { type: 'paragraph', text: '참고로 해상도가 올라갈수록 GPU 비중이 커지고 CPU 영향은 상대적으로 작아집니다. 그래서 1440p 이상부터는 그래픽카드 기준으로만 안내합니다.' },
      { type: 'paragraph', text: '24인치 FHD(1920×1080) — 경쟁 FPS 전용' },
      { type: 'table',
        headers: ['PC 사양', '240Hz 목표', '360Hz 목표'],
        rows: [
          ['보급형 (Ryzen 5 7600 / i5-13400F + RTX 4060급)', '도달 무난', '병목 발생 가능'],
          ['중급형 (Ryzen 7 9700X + RTX 5070급)', '여유롭게 안정', '대체로 도달'],
          ['상급형 X3D (Ryzen 7 9800X3D + RTX 5070급 이상)', '과분한 사양', '안정적으로 도달'],
        ] },
      { type: 'paragraph', text: '27인치 QHD(2560×1440) — 올라운드 표준' },
      { type: 'table',
        headers: ['PC 사양', '165Hz 목표', '240Hz 목표'],
        rows: [
          ['보급형 (RTX 5060급)', '경쟁 FPS는 무난, 무거운 게임은 미달', '대부분 미달'],
          ['중급형 (RTX 5070급)', '대부분 게임 도달 — 2026년 정석', '경쟁 FPS 위주로 근접'],
          ['상급형 (RTX 5080급)', '레이트레이싱 켜도 여유', '대부분 도달'],
        ] },
      { type: 'paragraph', text: '34인치 울트라와이드 QHD(3440×1440) 144Hz — 몰입감 중심 오픈월드·RPG' },
      { type: 'table',
        headers: ['PC 사양', '144Hz 목표'],
        rows: [
          ['중급형 (RTX 5070급)', '가벼운 게임 위주로 도달, 무거운 AAA는 미달'],
          ['중상급 (RTX 5070 Ti급)', '대부분의 AAA 타이틀에서 도달'],
          ['상급형 (RTX 5080급)', '레이트레이싱 켜도 여유'],
        ] },
      { type: 'paragraph', text: '32인치 4K(3840×2160) 144Hz — 그래픽 끝판왕' },
      { type: 'table',
        headers: ['PC 사양', '144Hz 목표'],
        rows: [
          ['상급형 (RTX 5080급)', 'DLSS4 업스케일링을 켜야 도달, 네이티브 렌더링은 부족'],
          ['플래그십 (RTX 5090급)', '네이티브 렌더링으로도 안정적으로 도달'],
        ] },
      { type: 'paragraph', text: '위 표는 일반적인 경향을 정리한 참고용 기준일 뿐, 그대로 맹신하지는 마세요. 게임마다 최적화 수준이 다르고, 같은 사양이라도 해상도·그래픽 옵션·드라이버 상태에 따라 실제 프레임은 꽤 달라질 수 있습니다.' },
      { type: 'paragraph', text: '내가 하려는 게임과 해상도, PC 사양을 직접 넣어서 더 정확하게 확인해보고 싶다면 pc-builds.com의 FPS 계산기(pc-builds.com/ko/fps-calculator/)를 참고해보세요.' },
      { type: 'paragraph', text: '④ 마지막으로 소소한 팁 하나 — 지금까지는 해상도·주사율 기준으로만 봤는데, 화질 체감에는 패널 종류도 큰 영향을 줍니다. 패널별 특징과 장단점을 정리해봤습니다.' },
      { type: 'table',
        headers: ['패널', '장점', '단점'],
        rows: [
          ['IPS', '색 재현력·시야각이 우수, 가장 대중적', '어두운 장면에서 살짝 뿌옇게 보이는 "IPS 글로우"'],
          ['VA', '명암비가 높아 검은색이 진하고 입체감 있음', '빠른 화면 전환에서 약간의 잔상(고스팅)'],
          ['TN', '응답속도가 빠르고 가격이 저렴', '색감·시야각이 가장 떨어짐, 요즘은 초저가 라인에만 남음'],
          ['OLED', '명암비·응답속도·색감 모두 최상급', '가격이 비싸고, 번인 우려가 있음(다만 최근 크게 개선)'],
        ] },
      { type: 'paragraph', text: 'IPS는 지금 팔리는 모니터의 절반 이상을 차지할 만큼 무난한 선택지입니다. 색이 정확하고 시야각이 넓어서 어떤 용도로든 무난하지만, 어두운 화면에서 살짝 뿌옇게 뜨는 "IPS 글로우"는 감안해야 합니다.' },
      { type: 'paragraph', text: 'VA는 명암비가 가장 큰 장점이라 어두운 배경의 게임이나 영화 감상에 잘 어울리지만, 고주사율에서도 약간의 잔상이 남을 수 있어 빠른 반응이 중요한 경쟁 FPS에는 상대적으로 불리합니다.' },
      { type: 'paragraph', text: 'TN은 예전엔 고주사율 경쟁 게이밍의 정석이었지만, 요즘은 IPS·OLED도 응답속도가 많이 따라잡아서 초저가 라인 외에는 잘 안 보입니다.' },
      { type: 'paragraph', text: 'OLED는 완전한 검은색과 압도적인 응답속도로 화질과 반응성을 동시에 잡을 수 있는 선택지입니다. 예전엔 번인(화면에 잔상이 눌어붙는 현상)이 큰 단점이었지만, 최근 패널은 소재가 개선되면서 내구성이 좋아졌고, 2026년 기준 프리미엄 OLED 모니터는 3~4년 번인 보증이 업계 표준처럼 자리 잡았습니다.' },
      { type: 'paragraph', text: '다만 가격이 여전히 비싸고, 작업표시줄이나 UI처럼 안 움직이는 화면을 오래 띄워두는 용도로는 다른 패널보다 조금 더 주의가 필요합니다.' },
      { type: 'paragraph', text: '혹시 지금 PC로 어느 정도 프레임이 나오는지, CPU와 GPU 중 뭐가 병목인지 궁금하시다면 아래 팁을 참고하세요.', linkTipId: 'gamer-tips-2', linkText: '프레임드랍 원인 자가진단법 보기' },
      { type: 'callout', text: '결론: 모니터를 먼저 정했다면 위 표에서 내 PC 사양이 목표 주사율 칸에 해당하는지 확인해보세요. 사양이 못 미친다면 해상도·주사율 목표를 낮추거나, 반대로 업그레이드 계획을 세우는 식으로 활용하시면 됩니다.' },
      { type: 'paragraph', text: '참고로 그래픽 옵션(그림자·반사 등 GPU 부하가 큰 항목)을 한두 단계만 낮춰도 프레임이 꽤 올라가는 경우가 많습니다. 표의 사양이 애매하게 부족하다면 옵션 조정부터 먼저 시도해보세요.' },
    ],
    tags: ['모니터', '주사율', 'GPU', 'PC견적'],
    date: '2026-08-16',
  },
];
