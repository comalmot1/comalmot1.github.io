...
export const tips = [
  ...
  },
  {
    ...
    body: [
      { type: 'paragraph', text: '"프레임드랍 원인 자가진단법"(팁 2번)에서 HWMonitor로 온도를 확인하는 법은 다뤘는데, 정작 "몇 도가 정상이고 몇 도부터 문제인지" 기준이 없으면 판단하기 어렵죠. 부품별로 유휴(Idle)·게이밍·풀부하 상태에서의 일반적인 온도 범위와, 이상 신호로 볼 수 있는 기준을 표로 정리했습니다.' },
